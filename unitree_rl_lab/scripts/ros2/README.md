...
SLAM팀 repo를 별도 workspace에 둔다.

```bash
mkdir -p ~/go2_roughnav_ws/src
git clone https://github.com/SeEEEun/go2_fast_trg.git \
...
python3 /home/nuri/unitree_rl_lab/scripts/ros2/sim2sim_ros2.py \
  --onnx /home/nuri/unitree_rl_lab/model_icros2026_v5_50000.onnx \
  --map icra2023_easy \
  --domain-id 42 \
